  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ trabajar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Cobra tu sueldo en el trabajo.\nRecuerda que sólo puedes usar este comando una vez cada 24 horas.')
        .addField('Uso', '`/econ trabajar`')
