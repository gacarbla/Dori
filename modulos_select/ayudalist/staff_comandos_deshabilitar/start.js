  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff comandos deshabilitar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Gracias a este comando puedes privar a los usuarios de tu servidor de gozar de alguna de las categorías de comandos si es que no te llega a convencer del todo.')
        .addField('Uso', '`/staff comandos deshabilitar <módulo>`')
