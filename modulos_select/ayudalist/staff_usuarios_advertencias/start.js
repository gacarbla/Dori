  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff usuarios advertencias`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Muestra un cuadro con toda las advertencias que posee el usuario indicado')
        .addField('Uso', '`/staff usuarios advertencias <usuario>`')
