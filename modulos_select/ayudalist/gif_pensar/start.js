...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un gif confome estás pensando intensamente en algo.\nSi mencionas un usuario indicarás que estás pensando en él/ella')
      .addField('Uso', '`/gif pensar [usuario]`')
