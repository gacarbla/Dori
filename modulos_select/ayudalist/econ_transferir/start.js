  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ transferir`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Transfiere dinero de tu cuenta bancaria a la de otra persona. Es un buen medio seguro para compartir dinero sin posibilidad de que te lo roben.')
        .addField('Uso', '`/econ transferir <cantidad> <usuario>`')
