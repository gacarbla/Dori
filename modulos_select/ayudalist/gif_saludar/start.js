...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un gif saludando a todo el mundo.\nMenciona un usuario para dirigir el saludo a una persona en concreto.')
      .addField('Uso', '`/gif saludar [usuario]`')
