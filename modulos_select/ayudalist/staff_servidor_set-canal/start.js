  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff servidor set-canal`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Establece un canal para la realización de una determinada acción o utilidad.')
        .addField('Uso', '`/staff servidor set-canal <acción> <canal>`')
