  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff usuarios limpiar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Borra las advertencias que un determinado usuario tiene en el servidor.')
        .addField('Uso', '`/staff usuarios limpiar <usuario>`')
