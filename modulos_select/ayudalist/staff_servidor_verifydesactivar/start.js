  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff servidor verify-desactivar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Desactiva el sistema de verificación en el servidor')
        .addField('Uso', '`/staff servidor verify-desactivar`')
