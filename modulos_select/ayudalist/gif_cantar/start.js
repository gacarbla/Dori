...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un gif para indicar que estás cantando.\nMenciona un usuario para indicar que la canción va dirigida a esa persona <3')
      .addField('Uso', '`/gif cantar [usuario]`')
