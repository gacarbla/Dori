...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un gif en el que un personaje está comiendo.\nMenciona un usuario para indicar que quieres probar el canibalismo')
      .addField('Uso', '`/gif comer [usuario]`')
