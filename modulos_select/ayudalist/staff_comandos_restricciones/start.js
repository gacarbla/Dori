  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff comandos restricciones`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Borra un determinado número de mensajes en el canal en el que se emplee')
        .addField('Uso', '`/staff comandos restricciones`')
