  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ comprar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Si la economía está activada en este servidor, con este comando podrás comprar ítems con el dinero que hayas ganado')
        .addField('Uso', '`/econ comprar`')
