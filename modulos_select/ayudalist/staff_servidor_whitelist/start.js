  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff servidor whitelist`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Gestiona la lista blanca del servidor.')
        .addField('Uso', '`/staff servidor whitelist <acción> <id>`')
        .addField('Permisos bot', 'Ver canales\nEnviar mensajes\nGestionar roles', true)
