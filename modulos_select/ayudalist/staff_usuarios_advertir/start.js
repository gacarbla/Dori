  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff usuarios advertir`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Registra en la base de datos una nueva advertencia para el usuario indicado')
        .addField('Uso', '`/staff usuarios advertir <usuario> [razón]`')
