...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un gif en el cuál dos personas se están abrazando y un texto dónde te menciona a ti y al otro usuario indicando que le has dado un abrazo.')
      .addField('Uso', '`/gif abrazar <usuario>`')
