  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ buscar-trabajo`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Si la economía del servidor está activada, con este comando podrás "buscar trabajo" para ganar más dinero.')
        .addField('Uso', '`/econ buscar-trabajo <profesión>`')
