  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff usuarios banear`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Banea un usuario y deja constancia de ello en el canal en el que se haya empleado el comando.')
        .addField('Uso', '`/staff usuarios banear <usuario> [razón]`')
