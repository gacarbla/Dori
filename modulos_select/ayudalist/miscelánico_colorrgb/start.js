...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/miscelánico color rgb`**')
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Obtén un color introduciendo si código rgb.')
      .addField('Uso', '`/miscelánico color rgb <rojo> <verde> <azul> <visibilidad>`')
