  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ estudiar`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Si la economía está activada en el servidor, con este comando podrás obtener títulos con los que conseguir empleos en los que ganes más dinero.')
        .addField('Uso', '`/econ estudiar <profesión>`')
