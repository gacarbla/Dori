  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/econ balance`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Si la economía está activada en el servidor, con este comando podrás ver la cantidad de dinero que posees')
        .addField('Uso', '`/econ balance [usuario]`')
