  ...
  run: async (client, interaction) => {
    try {
      ...
      var embed = new Discord.MessageEmbed()
        .setDescription('**CUADRO DE AYUDA**\n\n**Comando `/staff usuarios info`**')
        .setColor(0xfee75c)
        .addField('¿Qué hace?', 'Muestra un embed con toda la información que el bot ha sido capaz a recolectar del usuario en cuestión.')
        .addField('Uso', '`/staff usuarios info <usuario>`')
        .addField('Permisos bot', 'Ver canales\nEnviar mensajes', true)
        .addField('Permisos usuario', 'Enviar mensajes\nUsar comandos de aplicaciones\nExpulsar usuarios', true)
