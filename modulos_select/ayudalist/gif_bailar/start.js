...
module.exports = {
  run: async (client, interaction) => {
    ...
    var embed = new Discord.MessageEmbed()
      ...
      .setColor(0xfee75c)
      .addField('¿Qué hace?', 'Muestra un conforme estubieses bailando.\nMenciona un usuario para indicar que el baile va dirigido a esa persona <3')
      .addField('Uso', '`/gif bailar [usuario]`')
