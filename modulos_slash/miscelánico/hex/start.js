...
module.exports = {
    run: async (client, interaction) => {
      try{
        ...
        var color = interaction.options.getString('código')
        ...
        if (isOk === false) return require("../../../modulos_error/start").interact(client, interaction, "13", "no",  "", "reply", "El código debe ser válido y sin el símbolo #");
